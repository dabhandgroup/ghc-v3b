...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  royale: {
    ...
    url: "https://royale.com",
    urlDisplay: "royale.com",
  ...
  gritentertainment: {
    ...
    stats: [
      { value: "50K+", label: "Annual attendees", color: "#2563eb" },
      { value: "100+", label: "Events produced", color: "#2563eb" },
      { value: "30+", label: "Venue partnerships", color: "#2563eb" },
      { value: "AU-wide", label: "National coverage", color: "#2563eb" },
    ],
