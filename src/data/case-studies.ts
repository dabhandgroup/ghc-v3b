...
export const caseStudies: Record<string, CaseStudy> = {
  profiles: {
    ...
    url: "https://profiles.io",
    urlDisplay: "profiles.io",
    ...
    stats: [
      { value: "500M+", label: "Data records", color: "#7c3aed" },
      { value: "190+", label: "Countries", color: "#7c3aed" },
      { value: "<0.5s", label: "Query speed", color: "#7c3aed" },
      { value: "94%", label: "Data accuracy", color: "#7c3aed" },
    ],
  ...
  wardrobe: {
    ...
    url: "https://wardrobe.world",
    urlDisplay: "wardrobe.world",
    ...
    stats: [
      { value: "1st", label: "P2P fashion rental globally", color: "#7c3aed" },
      { value: "50K+", label: "Items listed", color: "#7c3aed" },
      { value: "4.9\u2605", label: "Average review", color: "#7c3aed" },
      { value: "62%", label: "Avg ROI for lenders", color: "#7c3aed" },
    ],
  ...
  royale: {
    ...
    url: "https://royale.world",
    urlDisplay: "royale.world",
    heroImage: "/images/royale-world.jpg",
    logo: "/images/logos/royale.svg",
    aboutTitle: "About Royale",
    about: "Royale.world is a next-generation online gaming and casino platform, built from the ground up with provable fairness, beautiful design, and an experience standard that makes incumbents look dated. It combines real-money gaming, sports, and esports in a single, elegantly designed platform.",
    stats: [
      { value: "<100ms", label: "Game response time", color: "#7c3aed" },
      { value: "99.98%", label: "Platform uptime", color: "#7c3aed" },
      { value: "200+", label: "Games at launch", color: "#7c3aed" },
      { value: "4.8\u2605", label: "App Store rating", color: "#7c3aed" },
    ],
  ...
  greatgaming: {
    ...
    url: "https://greatgaming.io",
    urlDisplay: "greatgaming.io",
    ...
    stats: [
      { value: "24/7", label: "Live studio operation", color: "#7c3aed" },
      { value: "50ms", label: "Stream latency", color: "#7c3aed" },
      { value: "30+", label: "Game titles", color: "#7c3aed" },
      { value: "99.99%", label: "Stream uptime", color: "#7c3aed" },
    ],
  ...
  platformone: {
    ...
    url: "https://platformone.com.au",
    urlDisplay: "platformone.com.au",
    ...
    stats: [
      { value: "680+", label: "Venue capacity", color: "#7c3aed" },
      { value: "3", label: "Distinct rooms", color: "#7c3aed" },
      { value: "1891", label: "Heritage-listed building", color: "#7c3aed" },
      { value: "Fri\u2013Sun", label: "Weekly operation", color: "#7c3aed" },
    ],
  ...
  gritentertainment: {
    slug: "gritentertainment",
    title: "Entertainment\ninfrastructure for\nthe next generation.",
    subtitle: "Entertainment \u00b7 Case Study",
    category: "Entertainment & Media",
    url: "https://gritentertainment.com.au",
    urlDisplay: "gritentertainment.com.au",
    heroImage: "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=1400&q=80&fit=crop",
    aboutTitle: "About Grit Entertainment",
    about: "Grit Entertainment is the entertainment and events arm of GHC, producing large-scale events, artist management, and venue operations across Australia. From music festivals to corporate events, Grit delivers end-to-end event production powered by proprietary technology and world-class creative direction.",
    stats: [
      { value: "50K+", label: "Annual attendees", color: "#7c3aed" },
      { value: "100+", label: "Events produced", color: "#7c3aed" },
      { value: "30+", label: "Venue partnerships", color: "#7c3aed" },
      { value: "AU-wide", label: "National coverage", color: "#7c3aed" },
    ],
    challenge: "Australia\u2019s entertainment industry was fragmented, with event production, artist management, and venue operations operating in silos. There was no vertically integrated player that could handle everything from concept to execution while leveraging technology to drive efficiency and audience engagement.",
    solution: "We built Grit Entertainment as a full-stack entertainment company: combining event production, artist management, and venue operations under one roof. Our proprietary platform handles ticketing, CRM, marketing automation, and real-time event analytics \u2014 giving us a competitive edge that traditional promoters can\u2019t match.",
    images: [
      { src: "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800&q=80&fit=crop", alt: "Grit Entertainment event" },
      { src: "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800&q=80&fit=crop", alt: "Grit Entertainment production" },
    ],
    outcomes: [
      "Produced 100+ events across Australia in the first 18 months",
      "Built a proprietary event management platform used by 30+ venues",
      "Grew to 50,000+ annual attendees across all events and venues",
      "Achieved 4.7-star average guest rating across all managed events",
    ],
    techStack: ["Next.js", "Node.js", "Stripe", "PostgreSQL", "Redis", "AWS", "React Native", "Custom Analytics Platform"],
  },
};
